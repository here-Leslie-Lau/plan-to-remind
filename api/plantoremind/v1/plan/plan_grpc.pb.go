...
type PlanClient interface {
	...
	CompletePlan(ctx context.Context, in *CompletePlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *planClient) CompletePlan(ctx context.Context, in *CompletePlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/api.plantoremind.v1.plan.Plan/CompletePlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPlanServer) CompletePlan(context.Context, *CompletePlanRequest) (*emptypb.Empty, error) {
...
func _Plan_CompletePlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompletePlanRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlanServer).CompletePlan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.plantoremind.v1.plan.Plan/CompletePlan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlanServer).CompletePlan(ctx, req.(*CompletePlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Plan_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Plan_CompletePlan_Handler,
		},
	},
